...
class Configurations:
    ...
    def _add_arguments(self):
        ...
        self.parser.add_argument('--datasets_path', type=str, default="F:\\airsim\\dataset_airsim", help="Path to the datasets folder")
        self.parser.add_argument('--dataset', type=str, default='dataset_plus', choices=['Room_all_agents', 'AirSim'], help="Dataset to use for training")
        ...
        self.parser.add_argument('--batch_size', type=int, default=2048, help="Batch size for training and evaluation")
        self.parser.add_argument('--micro_bsize', type=int, default=16, help="Micro-batch size for gradient accumulation")
        ...
        self.parser.add_argument('--min_tau', type=float, default=0.5, help="Minimum temperature")
        self.parser.add_argument('--max_tau', type=float, default=5, help="Maximum temperature")
        self.parser.add_argument('--learning_rate', type=float, default=0.0003, help="Learning rate for the optimizer")
